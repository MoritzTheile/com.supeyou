package com.supeyou.actor.web.client.rpc.session2event.query;
...
import com.supeyou.actor.web.client.rpc.session2event.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<Session2EventDTO, Session2EventFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(Session2EventFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(Session2EventFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(Session2EventFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(Session2EventFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
