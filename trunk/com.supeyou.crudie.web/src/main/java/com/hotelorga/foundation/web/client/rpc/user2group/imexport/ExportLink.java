package com.hotelorga.foundation.web.client.rpc.user2group.imexport;
...
import com.hotelorga.foundation.web.client.rpc.user2group.RPCCRUDServiceAsync;
...
public class ExportLink extends LinkButtonWidget {
	...
	public ExportLink(final User2GroupFetchQuery fetchQuery) {
