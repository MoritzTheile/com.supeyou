package com.hotelorga.foundation.web.client.rpc.user.imexport;
...
import com.hotelorga.foundation.web.client.rpc.user.RPCCRUDServiceAsync;
...
public class ExportLink extends LinkButtonWidget {
	...
	public ExportLink(final UserFetchQuery fetchQuery) {
