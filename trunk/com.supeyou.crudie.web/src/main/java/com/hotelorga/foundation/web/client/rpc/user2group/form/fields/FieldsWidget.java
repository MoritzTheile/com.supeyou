package com.hotelorga.foundation.web.client.rpc.user2group.form.fields;
...
import com.hotelorga.foundation.web.client.rpc.user2group.form.fields.field.FieldWidget;
		...
		put(
				...
				new AbstrDTOField<UserDTO>(thisDTO.getDtoA()) {
					...
					protected void showChooser(final ChooserAction<UserDTO> chooserAction) {
						popup = new PopupWidget(new com.hotelorga.foundation.web.client.rpc.user.choosersmall.ChooserSmallWidget(new SelectionListener<UserDTO>() {
		...
		put(
				...
				new AbstrDTOField<GroupDTO>(thisDTO.getDtoB()) {
					...
					protected void showChooser(final ChooserAction<GroupDTO> chooserAction) {
						popup = new PopupWidget(new com.hotelorga.foundation.web.client.rpc.group.choosersmall.ChooserSmallWidget(new SelectionListener<GroupDTO>() {
