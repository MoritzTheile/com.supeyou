package com.hotelorga.foundation.web.client.rpc.group.chooserlarge.item;
...
public class ItemWidget extends WidgetView {
	...
	private void render() {
		...
		columnThree.clear();
		columnThree.add(new com.hotelorga.foundation.web.client.rpc.user2group.assoaeditor.AssoAEditorWidget(thisDTO, false));
