package com.hotelorga.foundation.web.client.rpc.user.query;
...
import com.hotelorga.foundation.web.client.rpc.user.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<UserDTO, UserFetchQuery> dataProvider) {
		...
		}
		{
			...
			column2label.put(UserFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			column2label.put(UserFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			column2label.put(UserFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			column2label.put(UserFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
