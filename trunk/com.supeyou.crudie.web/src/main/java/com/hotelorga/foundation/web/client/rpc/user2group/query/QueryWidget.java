package com.hotelorga.foundation.web.client.rpc.user2group.query;
...
import com.hotelorga.foundation.web.client.rpc.user2group.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<User2GroupDTO, User2GroupFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(User2GroupFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(User2GroupFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(User2GroupFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(User2GroupFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
