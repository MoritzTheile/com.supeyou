package com.supeyou.crudie.web.client.rpc.user2group.form;
...
import com.supeyou.crudie.web.client.rpc.user2group.form.fields.FieldsWidget;
		...
		RPCCRUDProxy.i().updadd(dto, new AsyncCallback<User2GroupDTO>() {
			...
			public void onSuccess(User2GroupDTO result) {
				...
				if (!GWTSTATICS.nullsafeEquals(origDtoB, dto.getDtoB())) {
					com.supeyou.crudie.web.client.rpc.group.RPCCRUDProxy.i().wasUpdated(origDtoB);
					com.supeyou.crudie.web.client.rpc.group.RPCCRUDProxy.i().wasUpdated(dto.getDtoB());
				}
			}
