...
public interface Invitation2UserCRUDService extends CRUDAssoService<InvitationDTO, SupporterDTO, Invitation2SupporterIDType, AbstrAssoDTO<InvitationDTO, SupporterDTO, Invitation2SupporterIDType>, Invitation2SupporterFetchQuery> {
