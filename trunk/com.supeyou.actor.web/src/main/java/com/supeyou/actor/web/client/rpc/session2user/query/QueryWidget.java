package com.supeyou.actor.web.client.rpc.session2user.query;
...
import com.supeyou.actor.web.client.rpc.session2user.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<Session2UserDTO, Session2UserFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(Session2UserFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(Session2UserFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(Session2UserFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(Session2UserFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
