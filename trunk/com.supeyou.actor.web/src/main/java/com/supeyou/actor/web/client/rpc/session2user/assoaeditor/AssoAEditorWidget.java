package com.supeyou.actor.web.client.rpc.session2user.assoaeditor;
...
import com.supeyou.actor.web.client.rpc.session2user.assoaeditor.item.ItemWidget;
...
public class AssoAEditorWidget extends WidgetView {
	...
	public AssoAEditorWidget(UserDTO dto, final boolean showFormOnCreation) {
		thisDTO = dto;
	...
	private void showForm(final AbstrListDataProvider<Session2UserDTO, Session2UserFetchQuery> dataProvider, final AbstrListWidgetList<Session2UserDTO, Session2UserFetchQuery> listAbstrWidgetList, List<Session2UserDTO> selection) {
		if (selection.size() == 1) {
