package com.supeyou.actor.web.client.rpc.event.query;
...
import com.supeyou.actor.web.client.rpc.event.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<EventDTO, EventFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(EventFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(EventFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(EventFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(EventFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
