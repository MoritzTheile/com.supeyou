package com.supeyou.actor.web.client.rpc.actinguser.query;
...
import com.supeyou.actor.web.client.rpc.actinguser.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<ActingUserDTO, ActingUserFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(ActingUserFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(ActingUserFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(ActingUserFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(ActingUserFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
