package com.supeyou.actor.web.client.rpc.session2user.imexport;

import com.google.gwt.event.dom.client.ClickEvent;
import com.google.gwt.event.dom.client.ClickHandler;
import com.google.gwt.user.client.rpc.AsyncCallback;
import com.supeyou.actor.iface.dto.Session2UserFetchQuery;
import com.supeyou.actor.web.client.rpc.session2user.RPCCRUDServiceAsync;
...
public class ExportLink extends LinkButtonWidget {
	...
	public ExportLink(final Session2UserFetchQuery fetchQuery) {
