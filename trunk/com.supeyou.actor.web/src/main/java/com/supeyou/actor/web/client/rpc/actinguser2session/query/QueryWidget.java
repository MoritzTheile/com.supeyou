package com.supeyou.actor.web.client.rpc.actinguser2session.query;
...
import com.supeyou.actor.web.client.rpc.actinguser2session.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<ActingUser2SessionDTO, ActingUser2SessionFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(ActingUser2SessionFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(ActingUser2SessionFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(ActingUser2SessionFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(ActingUser2SessionFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
