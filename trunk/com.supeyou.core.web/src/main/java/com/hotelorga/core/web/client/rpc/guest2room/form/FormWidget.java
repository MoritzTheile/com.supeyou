package com.hotelorga.core.web.client.rpc.guest2room.form;
...
import com.hotelorga.core.web.client.rpc.guest2room.form.fields.FieldsWidget;
		...
		RPCCRUDProxy.i().updadd(dto, new AsyncCallback<Guest2RoomDTO>() {
			...
			public void onSuccess(Guest2RoomDTO result) {
				...
				if (!GWTSTATICS.nullsafeEquals(origDtoB, dto.getDtoB())) {
					com.hotelorga.core.web.client.rpc.room.RPCCRUDProxy.i().wasUpdated(origDtoB);
					com.hotelorga.core.web.client.rpc.room.RPCCRUDProxy.i().wasUpdated(dto.getDtoB());
				}
			}
