package com.hotelorga.core.web.client.rpc.guest2guestgroup.form;
...
import com.hotelorga.core.web.client.rpc.guest2guestgroup.form.fields.FieldsWidget;
		...
		RPCCRUDProxy.i().updadd(dto, new AsyncCallback<Guest2GuestGroupDTO>() {
			...
			public void onSuccess(Guest2GuestGroupDTO result) {
				...
				if (!GWTSTATICS.nullsafeEquals(origDtoB, dto.getDtoB())) {
					com.hotelorga.core.web.client.rpc.guestgroup.RPCCRUDProxy.i().wasUpdated(origDtoB);
					com.hotelorga.core.web.client.rpc.guestgroup.RPCCRUDProxy.i().wasUpdated(dto.getDtoB());
				}
			}
