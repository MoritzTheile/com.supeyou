package com.hotelorga.core.web.client.rpc.room.query;
...
import com.hotelorga.core.web.client.rpc.room.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<RoomDTO, RoomFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(RoomFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(RoomFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(RoomFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
