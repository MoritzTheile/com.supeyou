package com.hotelorga.core.web.client.rpc.guestgroupcalc.chooserlarge.item;
...
import com.hotelorga.core.web.client.rpc.guestgroupcalc.DownloadBillLink;
import com.hotelorga.core.web.client.rpc.guestgroupcalc.chooserlarge.item.guestscalculation.GuestsCalculationWidget;
import com.hotelorga.core.web.client.rpc.guestgroupcalc.createacceptanceforall.CreateAcceptanceForAll;
import com.hotelorga.core.web.client.rpc.guestgroupcalc.createguestgroupforall.CreateGuest2RoomForAll;
...
import com.hotelorga.foundation.web.client.rpc.abstr.crud.RPCAbstractCRUDProxy.ListenerHandler;
...
public class ItemWidget extends WidgetView {
	...
	private void getDataAndRender() {
		...
		com.hotelorga.core.web.client.rpc.guest.RPCCRUDServiceAsync.i.getGuestsCalculationDTO(thisDTO, from, to, new AsyncCallback<GuestsCalculationDTO>() {
	...
	protected void onLoad() {
		...
		listenerHandlers.add(com.hotelorga.core.web.client.rpc.guest.RPCCRUDProxy.i().addListenerForAllDTOs(new CRUDProxyListener<GuestDTO>() {
		...
		listenerHandlers.add(com.hotelorga.core.web.client.rpc.guest2guestgroup.RPCCRUDProxy.i().addListenerForAllDTOs(new CRUDProxyListener<Guest2GuestGroupDTO>() {
		...
		listenerHandlers.add(com.hotelorga.core.web.client.rpc.guestgroup.RPCCRUDProxy.i().addListenerForAllDTOs(new CRUDProxyListener<GuestGroupDTO>() {
		...
		listenerHandlers.add(com.hotelorga.core.web.client.rpc.guest2room.RPCCRUDProxy.i().addListenerForAllDTOs(new CRUDProxyListener<Guest2RoomDTO>() {
		...
		listenerHandlers.add(com.hotelorga.core.web.client.rpc.guest2acceptance.RPCCRUDProxy.i().addListenerForAllDTOs(new CRUDProxyListener<Guest2AcceptanceDTO>() {
		...
		listenerHandlers.add(com.hotelorga.core.web.client.rpc.acceptance.RPCCRUDProxy.i().addListenerForAllDTOs(new CRUDProxyListener<AcceptanceDTO>() {
