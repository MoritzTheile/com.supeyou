package com.hotelorga.core.web.client.rpc.guest2guestgroup.query;
...
import com.hotelorga.core.web.client.rpc.guest2guestgroup.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<Guest2GuestGroupDTO, Guest2GuestGroupFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(Guest2GuestGroupFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(Guest2GuestGroupFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(Guest2GuestGroupFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(Guest2GuestGroupFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
