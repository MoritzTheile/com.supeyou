package com.hotelorga.core.web.client.rpc.acceptance.form.fields;
...
import com.hotelorga.core.web.client.rpc.acceptance.form.fields.field.FieldWidget;
...
public class FieldsWidget extends WidgetView {
	...
	public FieldsWidget(AcceptanceDTO dto) {
		...
		if (dto.getId() != null) {
			...
			formColumn.add(new com.hotelorga.core.web.client.rpc.acceptance2payer.assobeditor.AssoBEditorWidget(dto, false));
		...
		if (dto.getId() != null) {
			...
			formColumn.add(new com.hotelorga.core.web.client.rpc.guest2acceptance.assobeditor.AssoBEditorWidget(dto, false));
