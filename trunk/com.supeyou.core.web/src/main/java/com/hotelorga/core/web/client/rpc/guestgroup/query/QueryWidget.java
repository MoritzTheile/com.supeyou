package com.hotelorga.core.web.client.rpc.guestgroup.query;
...
import com.hotelorga.core.web.client.rpc.guestgroup.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<GuestGroupDTO, GuestGroupFetchQuery> dataProvider) {
		...
		}
		{
			...
			column2label.put("creationTimestamp", "Erstellungsdatum");
			column2label.put("lastModifiedTimestamp", "Änderungsdatum");
			// column2label.put(GuestGroupFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(GuestGroupFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(GuestGroupFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
