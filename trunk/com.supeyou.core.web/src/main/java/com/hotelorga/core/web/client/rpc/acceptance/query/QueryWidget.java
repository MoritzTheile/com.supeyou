package com.hotelorga.core.web.client.rpc.acceptance.query;
...
import com.hotelorga.core.web.client.rpc.acceptance.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<AcceptanceDTO, AcceptanceFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(AcceptanceFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(AcceptanceFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(AcceptanceFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(AcceptanceFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
