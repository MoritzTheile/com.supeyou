package com.hotelorga.core.web.client.rpc.guest2acceptance.assobeditor.item;
...
public class ItemWidget extends WidgetView {
	...
	protected String renderInfoHTML(Guest2AcceptanceDTO dto) {
		String infos = "";
		infos += com.hotelorga.core.web.client.rpc.guest.choosersmall.item.ItemWidget.renderInfoString(thisDTO.getDtoA()) + " <-> " + Statics.renderDescription(dto.getDtoB());
