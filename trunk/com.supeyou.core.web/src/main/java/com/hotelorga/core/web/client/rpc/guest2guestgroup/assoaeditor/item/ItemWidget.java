package com.hotelorga.core.web.client.rpc.guest2guestgroup.assoaeditor.item;
...
public class ItemWidget extends WidgetView {
	...
	protected String renderInfoHTML(Guest2GuestGroupDTO dto) {
		String infos = "";
		infos += com.hotelorga.core.web.client.rpc.guest.chooserlarge.item.ItemWidget.renderHeaderString(thisDTO.getDtoA());
		infos += ", " + com.hotelorga.core.web.client.rpc.guest.chooserlarge.item.ItemWidget.renderInfoString(thisDTO.getDtoA());
