package com.hotelorga.core.web.client.rpc.guest.form.fields;
...
import com.hotelorga.core.web.client.fields.types.FieldForTitle;
import com.hotelorga.core.web.client.rpc.guest.form.fields.field.FieldWidget;
		...
		if (dto.getId() != null) {
			{
				...
				formColumn.add(new com.hotelorga.core.web.client.rpc.guest2room.assobeditor.AssoBEditorWidget(thisDto, true));
...

			{
				...
				formColumn.add(new com.hotelorga.core.web.client.rpc.guest2acceptance.assoaeditor.AssoAEditorWidget(thisDto, false));
...

			{
				...
				formColumn.add(new Label("Rechnungsgruppe"));
				formColumn.add(new com.hotelorga.core.web.client.rpc.guest2guestgroup.assobeditor.AssoBEditorWidget(thisDto, false));
