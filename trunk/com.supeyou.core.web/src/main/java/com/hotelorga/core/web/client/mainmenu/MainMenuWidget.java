package com.hotelorga.core.web.client.mainmenu;

import com.google.gwt.user.client.ui.Label;
import com.google.gwt.user.client.ui.Widget;
import com.hotelorga.core.web.client.mainmenu.othermenu.OtherMenuWidget;
import com.hotelorga.core.web.client.rpc.room.chooserlarge.ChooserLargeWidget;
		...
		MenuAndDisplay menuAndDisplay = new MenuAndDisplay(menu, display) {
			...
			public Widget getWidgetFor(Widget menuItem) {
				...
				if (menuItem4 == menuItem) {
					return new com.hotelorga.core.web.client.rpc.guestgroupcalc.chooserlarge.ChooserLargeWidget();
				}
