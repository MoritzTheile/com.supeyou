package com.supeyou.core.web.client.rpc.acceptance.chooserlarge.item;
...
public class ItemWidget extends WidgetView {
	...
	private void render() {
		...
		columnThree.clear();
		columnThree.add(new com.supeyou.core.web.client.rpc.guest2acceptance.assobeditor.AssoBEditorWidget(thisDTO, false));
