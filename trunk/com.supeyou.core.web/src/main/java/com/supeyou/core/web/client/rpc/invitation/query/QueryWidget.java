package com.supeyou.core.web.client.rpc.invitation.query;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<InvitationDTO, InvitationFetchQuery> dataProvider) {
