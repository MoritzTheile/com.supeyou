package com.supeyou.core.web.client.rpc.guestgroup.form.fields;
...
import com.supeyou.core.web.client.rpc.guestgroup.form.fields.field.FieldWidget;
...
public class FieldsWidget extends WidgetView {
	...
	public FieldsWidget(GuestGroupDTO dto) {
		...
		if (dto.getId() != null) {
			...
			formColumn.add(new com.supeyou.core.web.client.rpc.guest2guestgroup.assoaeditor.AssoAEditorWidget(thisDto, false));
