package com.supeyou.core.web.client.rpc.room.form.fields;
...
import com.supeyou.core.web.client.rpc.room.form.fields.field.FieldWidget;
...
public class FieldsWidget extends WidgetView {
	...
	public FieldsWidget(RoomDTO dto) {
		...
		// formColumn.add(new com.supeyou.core.web.client.rpc.guest2room.assoaeditor.AssoAEditorWidget(thisDto, true));
		//
