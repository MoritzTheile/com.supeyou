package com.supeyou.core.web.client.rpc.hero.query;
...
import com.supeyou.core.web.client.rpc.hero.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<HeroDTO, HeroFetchQuery> dataProvider) {
