package com.supeyou.core.web.client.rpc.guest2acceptance.form;
...
import com.supeyou.core.web.client.rpc.guest2acceptance.form.fields.FieldsWidget;
		...
		RPCCRUDProxy.i().updadd(dto, new AsyncCallback<Guest2AcceptanceDTO>() {
			...
			public void onSuccess(Guest2AcceptanceDTO result) {
				...
				if (!GWTSTATICS.nullsafeEquals(origDtoB, dto.getDtoB())) {
					com.supeyou.core.web.client.rpc.acceptance.RPCCRUDProxy.i().wasUpdated(origDtoB);
					com.supeyou.core.web.client.rpc.acceptance.RPCCRUDProxy.i().wasUpdated(dto.getDtoB());
				}
			}
