package com.supeyou.core.web.client.rpc.user2supporter.query;
...
import com.supeyou.core.web.client.rpc.user2supporter.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<User2SupporterDTO, User2SupporterFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(User2SupporterFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(User2SupporterFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(User2SupporterFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(User2SupporterFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
