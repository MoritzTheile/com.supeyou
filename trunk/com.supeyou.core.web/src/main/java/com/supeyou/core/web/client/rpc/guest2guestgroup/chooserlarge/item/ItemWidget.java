package com.supeyou.core.web.client.rpc.guest2guestgroup.chooserlarge.item;
...
public class ItemWidget extends WidgetView {
	...
	private void render() {
		...
		columnOne.clear();
		columnOne.add(new Label(com.supeyou.core.web.client.rpc.guest.choosersmall.item.ItemWidget.renderInfoString(thisDTO.getDtoA()) + " <-> " + thisDTO.getDtoB().getName()));
