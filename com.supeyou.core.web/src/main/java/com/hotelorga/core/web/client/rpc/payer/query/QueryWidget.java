package com.hotelorga.core.web.client.rpc.payer.query;
...
import com.hotelorga.core.web.client.rpc.payer.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<PayerDTO, PayerFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(PayerFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(PayerFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(PayerFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(PayerFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
