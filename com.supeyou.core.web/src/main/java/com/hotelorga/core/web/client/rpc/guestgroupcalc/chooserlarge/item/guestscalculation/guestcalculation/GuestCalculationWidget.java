...
import com.hotelorga.core.iface.common.HOTELHELPER;
...
import com.hotelorga.core.web.client.rpc.guestgroupcalc.chooserlarge.item.guestscalculation.guestcalculationdetail.GuestCalculationDetailWidget;
...
public class GuestCalculationWidget extends WidgetView {
	...
	private static Widget getGuestLink(final GuestCalculationDTO dto) {
		...
		LinkButtonWidget linkButtonWidget = new LinkButtonWidget(com.hotelorga.core.web.client.rpc.guest.chooserlarge.item.ItemWidget.renderHeaderString(dto.getGuestDTO()));
	...
	private Widget getRoomLink(final Guest2RoomDTO guest2RoomDTO) {
		...
		linkButtonWidget.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				formPopup.setPosition(100, 700);
				formPopup.init(
						new com.hotelorga.core.web.client.rpc.guest2room.form.FormWidget(null, guest2RoomDTO, false, false) {
							@Override
							protected void close() {
								formPopup.closePopup();
							}
