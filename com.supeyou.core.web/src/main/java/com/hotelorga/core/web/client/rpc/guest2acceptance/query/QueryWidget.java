package com.hotelorga.core.web.client.rpc.guest2acceptance.query;
...
import com.hotelorga.core.web.client.rpc.guest2acceptance.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<Guest2AcceptanceDTO, Guest2AcceptanceFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(Guest2AcceptanceFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(Guest2AcceptanceFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(Guest2AcceptanceFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(Guest2AcceptanceFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
