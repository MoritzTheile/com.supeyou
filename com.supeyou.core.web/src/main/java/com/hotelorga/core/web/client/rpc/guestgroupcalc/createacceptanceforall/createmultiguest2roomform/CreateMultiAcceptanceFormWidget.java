package com.hotelorga.core.web.client.rpc.guestgroupcalc.createacceptanceforall.createmultiguest2roomform;
...
import com.hotelorga.core.web.client.rpc.guestgroupcalc.createacceptanceforall.createmultiguest2roomform.fields.FieldsWidget;
...
public class CreateMultiAcceptanceFormWidget extends WidgetView {
	...
	private void save() {
		...
		com.hotelorga.core.web.client.rpc.acceptance.RPCCRUDProxy.i().updadd(dto, new AsyncCallback<AcceptanceDTO>() {
			...
			public void onSuccess(AcceptanceDTO acceptanceDTO) {
				...
				if (fieldsWidget.getPayer() != null) {
					...
					com.hotelorga.core.web.client.rpc.acceptance2payer.RPCCRUDProxy.i().updadd(acceptance2payer);
				} else {
			...
			private void createAcceptanceAssosPoppingFromListUntilEmpty(final AcceptanceDTO acceptanceDTO, final List<GuestDTO> guestDTOList) {
...

				{
					...
					com.hotelorga.core.web.client.rpc.guest2acceptance.RPCCRUDProxy.i().updadd(dto, new AsyncCallback<Guest2AcceptanceDTO>() {
