package com.hotelorga.core.web.client.rpc.guest2acceptance.chooserlarge.item;
...
public class ItemWidget extends WidgetView {
	...
	private void render() {
		...
		columnOne.clear();
		columnOne.add(new Label(com.hotelorga.core.web.client.rpc.guest.choosersmall.item.ItemWidget.renderInfoString(thisDTO.getDtoA()) + " <-> " + Statics.renderDescription(thisDTO.getDtoB())));
