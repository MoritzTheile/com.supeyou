package com.hotelorga.core.web.client.rpc.room.form;
...
import com.hotelorga.core.web.client.rpc.room.form.fields.FieldsWidget;
...
public class FormWidget extends WidgetView {
	...
	public FormWidget(AbstrListDataProvider<RoomDTO, RoomFetchQuery> dataProvider, RoomDTO userDTO) {

		init(dataProvider, userDTO);

	}

	public FormWidget(AbstrListDataProvider<RoomDTO, RoomFetchQuery> dataProvider) {

		init(dataProvider, new RoomDTO());

	}

	private void init(AbstrListDataProvider<RoomDTO, RoomFetchQuery> dataProvider, final RoomDTO dto) {
	...
	private void save(RoomDTO userDTO) {
		RPCCRUDProxy.i().updadd(userDTO, new AsyncCallback<RoomDTO>() {
