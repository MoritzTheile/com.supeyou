...
public class RPCInvitationCRUDServiceImpl extends RPCAbstrCRUDServiceImpl<InvitationDTO, InvitationFetchQuery> implements RPCCRUDService {
	...
	@Override
	public SupporterDTO followInvitation(UserDTO userDTO, SingleLineString256Type token) throws CRUDException {
		return ((InvitationCRUDService) getCRUDService()).followInvitation(getActor(), userDTO, token);
	}
