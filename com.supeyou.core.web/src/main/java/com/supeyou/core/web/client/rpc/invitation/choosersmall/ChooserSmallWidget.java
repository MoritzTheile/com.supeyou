package com.supeyou.core.web.client.rpc.invitation.choosersmall;
...
import com.supeyou.core.web.client.rpc.invitation.choosersmall.item.ItemWidget;
...
public class ChooserSmallWidget extends WidgetView {
	...
	private final SelectionListener<InvitationDTO> selectionListener;

	public ChooserSmallWidget(SelectionListener<InvitationDTO> selectionListener) {
		...
		AbstrListWidgetList<InvitationDTO, InvitationFetchQuery> widgetList = new AbstrListWidgetList<InvitationDTO, InvitationFetchQuery>(dataProvider) {
		...
		createLink.addDomHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				showCreationFormInPopup(new InvitationDTO());
			}
	...
	private void showCreationFormInPopup(InvitationDTO dto) {
		popup = new PopupWidget(
				...
				new FormWidget(dataProvider, dto) {
					...
					protected void updadded(InvitationDTO dto) {
						List<InvitationDTO> selection = new ArrayList<InvitationDTO>();
						selection.add(dto);
