package com.supeyou.core.web.client.rpc.supporter2invitation.query;
...
import com.supeyou.core.web.client.rpc.supporter2invitation.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<Supporter2InvitationDTO, Supporter2InvitationFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(Supporter2InvitationFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(Supporter2InvitationFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(Supporter2InvitationFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(Supporter2InvitationFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
