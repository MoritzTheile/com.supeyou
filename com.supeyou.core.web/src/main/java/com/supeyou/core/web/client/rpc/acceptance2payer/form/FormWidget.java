package com.supeyou.core.web.client.rpc.acceptance2payer.form;
...
import com.supeyou.core.web.client.rpc.acceptance2payer.form.fields.FieldsWidget;
		...
		RPCCRUDProxy.i().updadd(dto, new AsyncCallback<Acceptance2PayerDTO>() {
			...
			public void onSuccess(Acceptance2PayerDTO result) {
				...
				if (!GWTSTATICS.nullsafeEquals(origDtoA, dto.getDtoA())) {
					com.supeyou.core.web.client.rpc.acceptance.RPCCRUDProxy.i().wasUpdated(origDtoA);
					com.supeyou.core.web.client.rpc.acceptance.RPCCRUDProxy.i().wasUpdated(dto.getDtoA());
				}
				if (!GWTSTATICS.nullsafeEquals(origDtoB, dto.getDtoB())) {
					com.supeyou.core.web.client.rpc.payer.RPCCRUDProxy.i().wasUpdated(origDtoB);
					com.supeyou.core.web.client.rpc.payer.RPCCRUDProxy.i().wasUpdated(dto.getDtoB());
				}
			}
