package com.supeyou.core.web.client.rpc.guest2guestgroup.assobeditor.item;
...
public class ItemWidget extends WidgetView {
	...
	protected String renderInfoHTML(Guest2GuestGroupDTO dto) {
		String infos = "";
		infos += com.supeyou.core.web.client.rpc.guest.choosersmall.item.ItemWidget.renderInfoString(thisDTO.getDtoA()) + " <-> " + dto.getDtoB().getName();
