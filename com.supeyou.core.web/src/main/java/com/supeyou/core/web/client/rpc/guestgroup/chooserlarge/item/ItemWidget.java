package com.supeyou.core.web.client.rpc.guestgroup.chooserlarge.item;
...
public class ItemWidget extends WidgetView {
	...
	private void render() {
		...
		columnThree.clear();
		columnThree.add(new com.supeyou.core.web.client.rpc.guest2guestgroup.assoaeditor.AssoAEditorWidget(thisDTO, true));
