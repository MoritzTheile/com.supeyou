package com.supeyou.core.web.client.rpc.guest2guestgroup.assoaeditor;
...
import com.supeyou.core.web.client.rpc.guest.formmulti.FormMultiWidget;
...
import com.supeyou.core.web.client.rpc.guest2guestgroup.assoaeditor.item.ItemWidget;
		...
		{// adding Link
			...
			addLink.addDomHandler(new ClickHandler() {
				...
				public void onClick(ClickEvent event) {
					...
					popup.init(new com.supeyou.core.web.client.rpc.guest.choosersmall.ChooserSmallWidget(new SelectionListener<GuestDTO>() {
