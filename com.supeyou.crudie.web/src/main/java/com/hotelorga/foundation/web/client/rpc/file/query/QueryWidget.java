package com.hotelorga.foundation.web.client.rpc.file.query;
...
import com.hotelorga.foundation.web.client.rpc.file.query.sortdirection.SortDirectionWidget;
...
public class QueryWidget extends WidgetView {
	...
	public QueryWidget(final AbstrListDataProvider<FileDTO, FileFetchQuery> dataProvider) {
		...
		}
		{
			...
			// column2label.put(FileFetchQuery.COLUMN_EMAILADDRESS, Text.i.QUERY_COLUMN_EMAILADDRESS());
			// column2label.put(FileFetchQuery.COLUMN_BIRTHDATE, Text.i.QUERY_COLUMN_BIRTHDATE());
			// column2label.put(FileFetchQuery.COLUMN_AMOUNT, Text.i.QUERY_COLUMN_AMOUNT());
			// column2label.put(FileFetchQuery.COLUMN_ACTIVE, Text.i.QUERY_COLUMN_ACTIVE());
