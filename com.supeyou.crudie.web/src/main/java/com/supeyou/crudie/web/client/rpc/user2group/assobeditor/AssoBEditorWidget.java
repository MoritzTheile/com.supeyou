package com.supeyou.crudie.web.client.rpc.user2group.assobeditor;
...
import com.supeyou.crudie.web.client.rpc.user2group.assobeditor.item.ItemWidget;
		...
		{// adding Link
			...
			addLink.addDomHandler(new ClickHandler() {
				...
				event.stopPropagation();
					...
					popup.init(new com.supeyou.crudie.web.client.rpc.group.choosersmall.ChooserSmallWidget(new SelectionListener<GroupDTO>() {
